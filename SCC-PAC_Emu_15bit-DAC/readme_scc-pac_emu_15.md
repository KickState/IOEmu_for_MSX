...
* SCC-Emuに関しては、SCC-Emu Simplexと基本的に同じですので、SCC-Emu Simplexの[Readme](/SCC-Emu_Simplex_15bit-DAC/readme_scc-emu_15.md)を参照してください。
...
SCC-PAC EmuのSCC互換音源は、基本的にSCC-Emu Simplexと同じですので、SCC-Emu Simplex with 15-bit DACの[Readme](/SCC-Emu_Simplex_15bit-DAC/readme_scc-emu_15.md)を参照してください。
...
SCC-PAC Emu with 15-bit DAC版には、必ず、**15-bit DAC**用のHEXファイルを使用してください。
